...
public class Prescription {
	...
	public void createPrescription() throws SQLException {
		...
		ResultSet full_testrecord = this.conn.executeQuery("SELECT test_id, employee_no, patient_no, type_id  FROM test_record ORDER BY test_id");
